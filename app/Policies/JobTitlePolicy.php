...
class JobTitlePolicy
{
    ...
    {
        return $user->can('JobTitle.viewAny');
    ...
    {
        return $user->can('JobTitle.delete');
    ...
    {
        return $user->can('JobTitle.restore');
    ...
    {
        return $user->can('JobTitle.forceDelete');
